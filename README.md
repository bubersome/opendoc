...
* 2 [Python代码规范](/Article/codeSpecification/codeSpecification_Preface.md)
...
* 3 [第一个Python程序](/Article/PythonBasis/python1/Preface.md)
...
* 2 [基本数据类型和变量](/Article/PythonBasis/python2/Preface.md)
...
*  6 [函数](/Article/PythonBasis/python6/Preface.md)
...
* 7 [迭代器和生成器](/Article/PythonBasis/python7/Preface.md)
...
* 8 [面向对象](/Article/PythonBasis/python8/Preface.md)
...
* 9 [模块与包](/Article/PythonBasis/python9/Preface.md)
...
* 10 [Python 的 Magic Method](/Article/PythonBasis/python10/Preface.md)
...
* 11 [枚举类](/Article/python11/PythonBasis/Preface.md)
...
* 12[元类](/Article/PythonBasis/python12/Preface.md)
