...
if __name__ == "__main__":
    ...
    if args.class_name == "PythonClass":
        print("We are constructing a PythonClass")
        obj = PythonClass(name=args.name)
        print(obj)
        print(repr(obj))

    elif args.class_name == "PythonSuperClass":
        print("We are constructing a PythonSuperClass")
        if not args.items:
            print("No items passed in. Defaulting to: None")
            args.items = None
